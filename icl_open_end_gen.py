...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_in_4bit",default=True, action="store_true", help="Load model in 4-bit precision") # change 4 ->8 later
    ...
    if args.load_in_4bit:
        output_dir += "_4bit" #change back to 8
    ...
    if args.load_in_4bit:  #change back to 8
        gen_model = AutoModelForCausalLM.from_pretrained(
            args.gen_model_checkpoint,
            token=HF_TOKEN,
            device_map="auto",
            load_in_4bit=True  #change back to 8
        )
