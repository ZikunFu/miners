...
if __name__ == "__main__":
    ...
    if "mistralai/Mistral-7B-Instruct-v0.3" in args.gen_model_checkpoint or "Meta-Llama-3-" in args.gen_model_checkpoint or "google/gemma-1.1-7b-it" in args.gen_model_checkpoint or "Meta-Llama-3.1-" in args.gen_model_checkpoint or "google/gemma-2-9b-it" in args.gen_model_checkpoint:
        if args.load_in_8bit:
    ...
    for lang in dataset.LANGS:
        ...
        for k in [args.k]:
            ...
            for text_id in tqdm(range(len(test_texts))):
                ...
                elif "google/gemma-1.1-7b-it" in args.gen_model_checkpoint or "google/gemma-2-9b-it" in args.gen_model_checkpoint:
            ...
            if "google/gemma-1.1-7b-it" in args.gen_model_checkpoint or "gpt-3.5-turbo" in args.gen_model_checkpoint or "command-r" in args.gen_model_checkpoint or "google/gemma-2-9b-it" in args.gen_model_checkpoint:
